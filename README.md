...
본 연구는 로컬 실습용 화상회의 웹 클라이언트와 OWASP ZAP Baseline Scan 결과를 중심으로 수행되었다. 실제 운영형 Jitsi Meet의 TURN, XMPP, Jicofo, Jitsi Videobridge, 녹화 저장소, 인증 서버 전체를 직접 검증한 결과로 일반화하기에는 제한이 있다.
